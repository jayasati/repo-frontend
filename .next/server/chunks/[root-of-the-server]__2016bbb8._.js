module.exports = [
"[project]/.next-internal/server/app/api/history/trend/aggregated/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/history/trend/aggregated/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const bucket = req.nextUrl.searchParams.get('bucket') ?? 'weekly';
    const limit = Number(req.nextUrl.searchParams.get('limit') ?? '100');
    try {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$history$2e$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAggregatedTrend"])(repoUrl, bucket, limit, session.accessToken);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2016bbb8._.js.map