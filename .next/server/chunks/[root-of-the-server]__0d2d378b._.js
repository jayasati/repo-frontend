module.exports = [
"[project]/.next-internal/server/app/api/history/trend/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/api/history.api.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getDiff(fromId, toId, accessToken) {
    const params = new URLSearchParams({
        from: fromId,
        to: toId
    });
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiFetch"])(`/history/diff?${params}`, {
        method: 'GET',
        accessToken
    });
}
async function getTrend(repoUrl, limit = 30, accessToken) {
    const params = new URLSearchParams({
        repoUrl,
        limit: String(limit)
    });
...
"[project]/src/app/api/history/trend/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/auth.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$history$2e$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api/history.api.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api/client.ts [app-route] (ecmascript)");
;
;
;
...
async function GET(req) {
    ...
    if (!repoUrl) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'repoUrl query param is required'
        }, {
            status: 400
        });
    }
    ...
    try {
        const trend = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$history$2e$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTrend"])(repoUrl, limit, session.accessToken);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(trend);
    } catch (err) {
        if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"]) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: err.message
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d2d378b._.js.map