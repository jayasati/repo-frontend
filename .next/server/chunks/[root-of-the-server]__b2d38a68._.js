...
async function GET(_req, { params }) {
    ...
    try {
        const branches = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiFetch"])(`/auth/github/repos/${encodeURIComponent(owner)}/${encodeURIComponent(repo)}/branches`, {
            method: 'GET',
        ...
        if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"] && err.status === 403) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json([], {
                status: 200
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2d38a68._.js.map