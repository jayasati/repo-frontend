module.exports = [
"[project]/.next-internal/server/app/api/history/target/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/history/target/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiFetch"])(`/history/target?${params}`, {
            method: 'GET',
...
async function PUT(req) {
    ...
    try {
        ...
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiFetch"])('/history/target', {
            method: 'PUT',
            accessToken: session.accessToken,
            body
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__740e59f0._.js.map