...
"[project]/src/lib/github/nest-github-repo.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function stableNumericId(fullName) {
    let h = 0;
...
function mapNestGithubRepoToUi(r) {
    return {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/auth.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api/client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$github$2f$nest$2d$github$2d$repo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/github/nest-github-repo.ts [app-route] (ecmascript)");
;
;
;
;
async function GET(_req) {
    ...
    try {
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiFetch"])('/auth/github/repos', {
            method: 'GET',
            accessToken: session.accessToken
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(rows.map(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$github$2f$nest$2d$github$2d$repo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mapNestGithubRepoToUi"]));
    } catch (err) {
        if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"]) {
            const msg = String(err.message ?? '');
            const noGithub = err.status === 403 || err.status === 404 && /no github account linked|github account not linked|not linked for this user/i.test(msg);
            if (noGithub) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f42a823._.js.map