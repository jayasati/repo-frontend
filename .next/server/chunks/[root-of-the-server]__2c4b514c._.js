module.exports = [
"[project]/.next-internal/server/app/api/analyze/[jobId]/progress/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/analyze/[jobId]/progress/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    const backendUrl = `${("TURBOPACK compile-time value", "http://localhost:3000") ?? 'http://localhost:3000'}/analyze/${jobId}/progress`;
    const headers = {
    ...
    if (!backendResponse.ok || !backendResponse.body) {
        return new Response('Failed to connect to analysis stream', {
            status: 502
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c4b514c._.js.map