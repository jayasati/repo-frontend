module.exports = [
"[project]/.next-internal/server/app/api/analyze/[jobId]/report/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/analyze/[jobId]/report/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    const backendUrl = `${("TURBOPACK compile-time value", "http://localhost:3000") ?? 'http://localhost:3000'}/analyze/${jobId}/report?format=${format}`;
    const headers = {};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01578e5d._.js.map