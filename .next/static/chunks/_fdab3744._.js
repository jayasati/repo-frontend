...
function UrlScanner() {
    ...
    function normalise(raw) {
        ...
        if (/^[\w.-]+\/[\w.-]+$/.test(trimmed)) return "https://github.com/".concat(trimmed);
        return null;
    }
    const handleSubmit = async (overrideUrl)=>{
        const source = normalise(overrideUrl !== null && overrideUrl !== void 0 ? overrideUrl : rawInput);
        if (!source) {
...
function GitHubRepoSelector() {
    ...
    const handleConnectGitHub = async ()=>{
        ...
        try {
            // Use NextAuth signIn — properly registers the OAuth flow and returns the
            // GitHub access token into the session. Using an <a href> tag would work
            // but loses client state and can fail if the provider isn't configured.
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('GitHub sign-in failed. Please try again.');
...
//# sourceMappingURL=_fdab3744._.js.map