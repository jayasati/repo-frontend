...
function TrendChart(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrendChart.useEffect": ()=>{
            ...
            setIsLoading(true);
            setError(null);
            fetch("/api/history/trend?repoUrl=".concat(encodeURIComponent(repoUrl), "&limit=30")).then({
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: new Date((_report_points__analyzedAt = (_report_points_ = report.points[0]) === null || _report_points_ === void 0 ? void 0 : _report_points_.analyzedAt) !== null && _report_points__analyzedAt !== void 0 ? _report_points__analyzedAt : '').toLocaleDateString('en-US', {
                                    month: 'short',
                                    day: 'numeric'
                                })
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "font-mono text-[10px] text-text-dim",
                                children: new Date((_report_points_at_analyzedAt = (_report_points_at = report.points.at(-1)) === null || _report_points_at === void 0 ? void 0 : _report_points_at.analyzedAt) !== null && _report_points_at_analyzedAt !== void 0 ? _report_points_at_analyzedAt : '').toLocaleDateString('en-US', {
                                    month: 'short',
                                    day: 'numeric'
                                })
                            }, void 0, false, {
...
function TrendsPage() {
    ...
    const handleSearch = ()=>{
        const url = input.trim().startsWith('http') ? input.trim() : input.trim() ? "https://github.com/".concat(input.trim()) : '';
...
_s(TrendsPage, "b/1liKSKRQW+p1Q9aJVCsmrMKYI=");
_c = TrendsPage;
var _c;
...
//# sourceMappingURL=src_4e8b3a17._.js.map