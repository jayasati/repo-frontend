...
function HistoryList(param) {
    let { repoUrl, onSelectForDiff, selected } = param;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HistoryList.useEffect": ()=>{
            ...
            setIsLoading(true);
            setError(null);
            fetch("/api/history?repoUrl=".concat(encodeURIComponent(repoUrl), "&limit=20")).then({
                ...
                "HistoryList.useEffect": (data)=>setEntries(data)
...
_s(HistoryList, "rP/fw87obd4bABz6C+ohf3Xhe/8=");
_c = HistoryList;
var _c;
...
_s(HistoryPage, "zEPG6o6H3pjuf2cmN8zygKnjnGQ=");
_c = HistoryPage;
var _c;
...
//# sourceMappingURL=_a8bb60d5._.js.map