...
function HistoryList(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HistoryList.useEffect": ()=>{
            ...
            setIsLoading(true);
            setError(null);
            fetch("/api/history?repoUrl=".concat(encodeURIComponent(repoUrl), "&limit=").concat(limit)).then({
...
_s(HistoryPage, "YeluSS4RF9N1SSDmsn800lAxIbc=");
_c = HistoryPage;
var _c;
...
//# sourceMappingURL=_4f4e2e32._.js.map